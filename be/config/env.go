...
var (
	...
	BaseURL                 = GetEnv("BE_BASE_URL", "/tkbai")
	AdminLoginURL           = WebHost + BaseURL + "/login/admin"
	...
	IAMLoginRedirectURL     = APIHost + BaseURL + IAMLoginRedirectPath
	IAMLoginRedirect302URL  = WebHost + BaseURL + IAMLoginRedirect302Path
	IAMLogoutRedirectURL    = APIHost + BaseURL + IAMLogoutRedirectPath
